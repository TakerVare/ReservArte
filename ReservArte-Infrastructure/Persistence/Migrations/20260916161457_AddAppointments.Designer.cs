...
namespace ReservArte.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916161457_AddAppointments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReservArte.Domain.Entities.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReservArte.Domain.Entities.ServiceCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReservArte.Domain.Entities.ServicePackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReservArte.Domain.Entities.ServicePackageItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ServicePackageId", "Order");

                    b.ToTable("ServicePackageItems", (string)null);
                });

            modelBuilder.Entity("ReservArte.Domain.Entities.ServicePricing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReservArte.Domain.Entities.ServiceVariation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReservArte.Domain.Entities.WaitingList", b =>
                {
                    ...
                    b.ToTable("WaitingList", null, t =>
                        {
                            t.HasCheckConstraint("CK_WaitingList_DateRange", "[DateRangeEnd] > [DateRangeStart]");
                        });
                });
            ...
            modelBuilder.Entity("ReservArte.Domain.Entities.Service", b =>
                {
                    b.HasOne("ReservArte.Domain.Entities.ServiceCategory", "Category")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("ReservArte.Domain.Entities.ServicePackageItem", b =>
                {
                    ...
                    b.HasOne("ReservArte.Domain.Entities.ServicePackage", "ServicePackage")
                        .WithMany("Items")
