...
>
> **RA-869d7f4n4 → shipped (2026-09-16), PR #74 (`3def77c`).** Repositorio de Citas. Recuento del padre **RA-869d7edau:** **3/11**. `IAppointmentRepository` / `AppointmentFilter` en Domain; `AppointmentRepository` en `Persistence/Repositories`. Sin `orgId` en la firma. `AppointmentRepositoryTests` (22). Unit **432/432**. E2E **57/57** (SPA no se toca; no reejecutados). `dotnet format` EXIT 0. Sin migración ni `data/`. Siguiente: **RA-869d7f4rd**. Detalle: vol. 2 **§9.9**.
>
...
- ⏳ API de citas
  - CRUD completo
  - Validación de disponibilidad — **RA-869d7f4rd** (siguiente)
...
>
> **Módulo Citas (RA-869d7edau):** **3/11** (2026-09-16, PR #74). Padre en `in development` (fechas 2026-09-16 → 2026-09-25). Shipped: **RA-869d7f4f1** (entidades Domain), **RA-869d7f4j8** (mapeo) y **RA-869d7f4n4** (repositorio). El denominador pasó de 10 a 11 al crear **RA-869f2yh9b**. Siguiente: **RA-869d7f4rd**. Detalle: vol. 2 **§9.9**.
>
...
- [x] **Backend unitario:** proyecto `tests/ReservArte.UnitTests` con xUnit + Moq + FluentAssertions; suite **432/432** (2026-09-16, PR #74). Repositorios: SQLite en memoria. `[reservarte-testing-strategy.md](reservarte-testing-strategy.md)` §3.1
