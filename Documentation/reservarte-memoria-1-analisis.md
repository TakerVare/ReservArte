...
>
> **Pendientes del bloque (3):** endpoints GET/POST/PUT — **RA-869d7f3bt** (**siguiente**). `CustomerPaymentMethod.OrganizationId` y `/history` — **RA-869d7f3fw**. Contador de no-shows, `IncrementNoShowAsync` y el test de bloqueo al umbral — **RA-869d7f3ka** (trasladado desde RA-869d7f369; el test de no-shows se absorbe de **RA-869d7f3q4**, cancelada). Promoción `new` → `regular` — **RA-869f2g02q** (Citas, no cuenta en el 7). Alta pública — **RA-869f1xc2n** (**shipped**, PR #59). Servicio — **RA-869d7f369** (**shipped**, PR #60). Unicidad de email por org — **RA-869f1xc0u** (**shipped**, PR #57; independiente, no suma al 7). Cadena: **RA-869f1xc0u** (hecha) → **RA-869d7f32r** (hecha) → **RA-869f1xc2n** (hecha) → **RA-869d7f369** (hecha).
>
