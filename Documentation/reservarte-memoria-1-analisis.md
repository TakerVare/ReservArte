...
POST   /api/v1/customers/{id}/notes        # Admin|Manager|Employee; body { note } (obligatoria, no solo espacios, ≤2000, recorte); 201 CustomerNoteDto { id, note, employeeId, createdAt } + Location a GET /customers/{id} | 400 field=note | 403 si quien llama no tiene ficha Employee ACTIVA en el centro | 404 cliente
