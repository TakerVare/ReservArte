...
### 9.7 Dominio, persistencia y servicio — módulo de Clientes (RA-869d7f2z5 + RA-869d7f32r + RA-869f1xc2n + RA-869d7f369)
...
**RA-869d7f369 (PR #60, 2026-09-15) — shipped.** Capa de servicio, **sin endpoints** (siguen en RA-869d7f3bt). Recuento del padre: **4/8**. Cadena: **RA-869f1xc0u** (hecha) → **RA-869d7f32r** (hecha) → **RA-869f1xc2n** (hecha) → **RA-869d7f369** (hecha). Siguiente del bloque: **RA-869d7f3bt**.
...
**Abiertos:** **RA-869d7f3bt** (**siguiente**; Endpoints GET/POST/PUT `/api/v1/customers` con búsqueda avanzada y filtros); no-shows / `IncrementNoShowAsync` **RA-869d7f3ka** (trasladado desde RA-869d7f369); promoción de categoría **RA-869f2g02q**; **RA-869d7f3fw** (`OrganizationId` en `CustomerPaymentMethod` y `/history`); **RA-869d7f3q4** (Tests unitarios: crear sin consentimiento debe fallar + bloqueo por no-shows — parte del consentimiento ya cubierto en el servicio). Servicio **RA-869d7f369** (**shipped**, PR #60). Alta pública **RA-869f1xc2n** (**shipped**, PR #59). Unicidad **RA-869f1xc0u** (**shipped**, PR #57; independiente, no suma al 8).
