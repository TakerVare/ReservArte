...
**Abiertos del bloque (3):** **RA-869d7f3bt** (**siguiente**; Endpoints GET/POST/PUT `/api/v1/customers` con búsqueda avanzada y filtros); **RA-869d7f3fw** (`OrganizationId` en `CustomerPaymentMethod` y `/history`); **RA-869d7f3ka** (`NoShowCount`, política, `IncrementNoShowAsync` y test de bloqueo al umbral; trasladado desde RA-869d7f369; test absorbido de RA-869d7f3q4). Promoción de categoría **RA-869f2g02q** (Citas, no cuenta en el 7). **RA-869d7f3q4 cancelada** (2026-09-15): consentimiento ya en PR #60; no-shows con RA-869d7f3ka. Servicio **RA-869d7f369** (**shipped**, PR #60). Alta pública **RA-869f1xc2n** (**shipped**, PR #59). Unicidad **RA-869f1xc0u** (**shipped**, PR #57; independiente, no suma al 7).
