...
>
> **Set-password (2026-09-14, RA-869f17y68, PR #51):** spec `reservarte-web/e2e/set-password.spec.ts` — token decodificado una vez; enlace sin token; enlace caducado muestra error **sin** cerrar sesión (`AUTH_ENDPOINTS_WITHOUT_SESSION`). Suite E2E **48/48** (antes **39**; 13→16 tests × 3 navegadores). `AuthService.SetPasswordAsync` no tiene unitarios; cubierto en runtime.
>
