...
>
> **Fin de sesión (2026-09-13, RA-869f18urw + PR #44):** spec `reservarte-web/e2e/session-ending.spec.ts` — 403 + `ORG_TENANT_MISMATCH` cierra sesión; **403 sin cuerpo** (forma real de `[Authorize(Roles)]`) no; 403 con otro código en envelope tampoco. Las llamadas se provocan **desde la app**. Suite Playwright **39/39**. El hueco de envelope en la API: **RA-869f1anz3**.
>
